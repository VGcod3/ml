    ...
    return (
        <>
            <Box className="px-10 min-h-screen flex flex-col my-11 justify-center gap-12 backdrop-blur-md" id="ejc">
                ...
                >
                    Я довго думав як почати МЛ, бо перше враження це важливо. І придумав я мотивацію, бо все на світі можна навчитися робити і зробити. Було би бажання. Отже, МОТИВАЦІЯ ЗАРІШАЄ.
                </motion.p>
                <motion.h2
                ...
                >
                    ...
                    <p>
                        Хах, ото прикол. Як кажуть мудрі люди, і база знань, ІЯК - найбільший проект, який принесе фінансування у левову частку інших проектів. Отже, до цього і я можу прикласти руку. І я постараюся виконати свої обов’язки якнайкраще, внести певні ідеї в організації проекту в цілому, й поза ІТ. Бо кортім - це сім’я, конекшн який буде зв’язувати людей, що трудилися разом ще довго. Крім того, участь в кортімі більше інтегрує мене в організацію, дасть хороший авторитет серед Besties and Bestiemen♠️.
                    </p>
                </motion.div>
                <motion.h2
